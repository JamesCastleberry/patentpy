# This is the program that converts the old (Before 2005) XML patent file format to an easy to read CSV file that pulls important
#information about each patent. (The Patent Number, Patent Title, Date Published, Description, Number of Cited Patents, and Cited Patent Numbers.)
